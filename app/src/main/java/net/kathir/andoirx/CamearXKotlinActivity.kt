...
import kotlinx.android.synthetic.main.kotlin_camera_view.*
import java.io.File
...
class CamearXKotlinActivity : AppCompatActivity(), LifecycleOwner
{
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.kotlin_camera_view)
